...
export class ServerApi extends runtime.BaseAPI {
  ...
  async featuresGetRaw(
    requestParameters: FeaturesGetRequest,
  ): Promise<runtime.ApiResponse<QueryResult>> {
  ...
  async featuresGet(
    ...
    const response = await this.featuresGetRaw(requestParameters);
