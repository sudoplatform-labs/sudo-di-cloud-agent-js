...
export class PresentProofV20Api extends runtime.BaseAPI {
  ...
  async presentProof20RecordsPresExIdProblemReportPost(
    ...
    const response = await this.presentProof20RecordsPresExIdProblemReportPostRaw(
      requestParameters,
    );
    return await response.value();
  }
  ...
  async presentProof20RecordsPresExIdSendPresentationPost(
    ...
    const response = await this.presentProof20RecordsPresExIdSendPresentationPostRaw(
      requestParameters,
    );
    return await response.value();
  }
  ...
  async presentProof20RecordsPresExIdVerifyPresentationPost(
    ...
    const response = await this.presentProof20RecordsPresExIdVerifyPresentationPostRaw(
      requestParameters,
    );
    return await response.value();
  }
