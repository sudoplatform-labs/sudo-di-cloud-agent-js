...
export class ActionMenuApi extends runtime.BaseAPI {
  ...
  async actionMenuConnIdPerformPost(
    ...
    const response =
      await this.actionMenuConnIdPerformPostRaw(requestParameters);
    return await response.value();
  }
  ...
  async actionMenuConnIdRequestPost(
    ...
    const response =
      await this.actionMenuConnIdRequestPostRaw(requestParameters);
    return await response.value();
  }
  ...
  async actionMenuConnIdSendMenuPost(
    ...
    const response =
      await this.actionMenuConnIdSendMenuPostRaw(requestParameters);
    return await response.value();
  }
}
