...
export class EndorseTransactionApi extends runtime.BaseAPI {
  ...
  async transactionTranIdResendPost(
    ...
    const response =
      await this.transactionTranIdResendPostRaw(requestParameters);
  ...
  async transactionsConnIdSetEndorserInfoPost(
    ...
    const response =
      await this.transactionsConnIdSetEndorserInfoPostRaw(requestParameters);
    return await response.value();
  }
  ...
  async transactionsConnIdSetEndorserRolePost(
    ...
    const response =
      await this.transactionsConnIdSetEndorserRolePostRaw(requestParameters);
    return await response.value();
  }
  ...
  async transactionsCreateRequestPost(
    ...
    const response =
      await this.transactionsCreateRequestPostRaw(requestParameters);
    return await response.value();
  }
  ...
  async transactionsTranIdCancelPost(
    ...
    const response =
      await this.transactionsTranIdCancelPostRaw(requestParameters);
    return await response.value();
  }
  ...
  async transactionsTranIdEndorsePost(
    ...
    const response =
      await this.transactionsTranIdEndorsePostRaw(requestParameters);
    return await response.value();
  }
  ...
  async transactionsTranIdRefusePost(
    ...
    const response =
      await this.transactionsTranIdRefusePostRaw(requestParameters);
    return await response.value();
  }
  ...
  async transactionsTranIdWritePost(
    ...
    const response =
      await this.transactionsTranIdWritePostRaw(requestParameters);
    return await response.value();
  }
}
