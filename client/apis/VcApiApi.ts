...
import {
  ...
  StoreCredentialRequestFromJSON,
  StoreCredentialRequestToJSON,
  StoreCredentialResponse,
  StoreCredentialResponseFromJSON,
  StoreCredentialResponseToJSON,
...
export interface VcCredentialsStorePostRequest {
...
export class VcApiApi extends runtime.BaseAPI {
  ...
  async vcCredentialsCredentialIdGet(
    ...
    const response =
      await this.vcCredentialsCredentialIdGetRaw(requestParameters);
   ...
   * List credentials
   */
  async vcCredentialsGetRaw(): Promise<
    runtime.ApiResponse<ListCredentialsResponse>
  > {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ListCredentialsResponseFromJSON(jsonValue),
    );
  }
   ...
   * List credentials
   */
  async vcCredentialsGet(): Promise<ListCredentialsResponse> {
   ...
   * Store a credential
   */
  async vcCredentialsStorePostRaw(
    requestParameters: VcCredentialsStorePostRequest,
  ): Promise<runtime.ApiResponse<StoreCredentialResponse>> {
    const queryParameters: any = {};
    ...
    const response = await this.request({
      ...
      headers: headerParameters,
      query: queryParameters,
      body: StoreCredentialRequestToJSON(requestParameters.body),
    });

    return new runtime.JSONApiResponse(response, (jsonValue) =>
      StoreCredentialResponseFromJSON(jsonValue),
    );
  }
   ...
   * Store a credential
   */
  async vcCredentialsStorePost(
    requestParameters: VcCredentialsStorePostRequest,
  ): Promise<StoreCredentialResponse> {
    const response = await this.vcCredentialsStorePostRaw(requestParameters);
    return await response.value();
  }
