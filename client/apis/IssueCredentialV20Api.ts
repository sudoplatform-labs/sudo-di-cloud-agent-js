...
export class IssueCredentialV20Api extends runtime.BaseAPI {
  ...
  async issueCredential20CreateOfferPost(
    ...
    const response =
      await this.issueCredential20CreateOfferPostRaw(requestParameters);
  ...
  async issueCredential20CreatePost(
    ...
    const response =
      await this.issueCredential20CreatePostRaw(requestParameters);
    return await response.value();
  }
  ...
  async issueCredential20RecordsCredExIdDelete(
    ...
    const response =
      await this.issueCredential20RecordsCredExIdDeleteRaw(requestParameters);
    return await response.value();
  }
  ...
  async issueCredential20RecordsCredExIdGet(
    ...
    const response =
      await this.issueCredential20RecordsCredExIdGetRaw(requestParameters);
    return await response.value();
  }
  ...
  async issueCredential20RecordsCredExIdIssuePost(
    ...
    const response =
      await this.issueCredential20RecordsCredExIdIssuePostRaw(
        requestParameters,
      );
    return await response.value();
  }
  ...
  async issueCredential20RecordsCredExIdStorePost(
    ...
    const response =
      await this.issueCredential20RecordsCredExIdStorePostRaw(
        requestParameters,
      );
    return await response.value();
  }
  ...
  async issueCredential20RecordsGet(
    ...
    const response =
      await this.issueCredential20RecordsGetRaw(requestParameters);
    return await response.value();
  }
  ...
  async issueCredential20SendOfferPost(
    ...
    const response =
      await this.issueCredential20SendOfferPostRaw(requestParameters);
    return await response.value();
  }
  ...
  async issueCredential20SendProposalPost(
    ...
    const response =
      await this.issueCredential20SendProposalPostRaw(requestParameters);
    return await response.value();
  }
  ...
  async issueCredential20SendRequestPost(
    ...
    const response =
      await this.issueCredential20SendRequestPostRaw(requestParameters);
    return await response.value();
  }
}
