...
export class MediationApi extends runtime.BaseAPI {
  ...
  async mediationKeylistsMediationIdSendKeylistQueryPost(
    ...
    const response = await this.mediationKeylistsMediationIdSendKeylistQueryPostRaw(
      requestParameters,
    );
    return await response.value();
  }
  ...
  async mediationKeylistsMediationIdSendKeylistUpdatePost(
    ...
    const response = await this.mediationKeylistsMediationIdSendKeylistUpdatePostRaw(
      requestParameters,
    );
    return await response.value();
  }
