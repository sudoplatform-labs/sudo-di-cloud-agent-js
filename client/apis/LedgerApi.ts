...
import {
  ...
  RegisterLedgerNymResponseFromJSON,
  RegisterLedgerNymResponseToJSON,
  TAAAccept,
  TAAAcceptFromJSON,
  TAAAcceptToJSON,
  TAAResult,
...
export class LedgerApi extends runtime.BaseAPI {
  ...
  async ledgerRegisterNymPostRaw(
  ...
  ): Promise<runtime.ApiResponse<RegisterLedgerNymResponse>> {
    if (requestParameters.did === null || requestParameters.did === undefined) {
      throw new runtime.RequiredError(
        'did',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      RegisterLedgerNymResponseFromJSON(jsonValue),
    );
  }
