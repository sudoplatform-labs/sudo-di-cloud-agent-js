...
import {
  ...
  ConfigurableWriteLedgersFromJSON,
  ConfigurableWriteLedgersToJSON,
...
export interface LedgerLedgerIdSetWriteLedgerPutRequest {
  ledgerId: string;
}
...
export class LedgerApi extends runtime.BaseAPI {
   ...
   */
  async ledgerConfigGetRaw(): Promise<runtime.ApiResponse<LedgerConfigList>> {
   ...
   * Fetch the multiple ledger configuration currently in use
   */
  async ledgerConfigGet(): Promise<LedgerConfigList> {
    const response = await this.ledgerConfigGetRaw();
   ...
   */
  async ledgerGetWriteLedgerGetRaw(): Promise<
    runtime.ApiResponse<WriteLedger>
  > {
    const queryParameters: any = {};
   ...
   * Fetch the current write ledger
   */
  async ledgerGetWriteLedgerGet(): Promise<WriteLedger> {
    const response = await this.ledgerGetWriteLedgerGetRaw();
    return await response.value();
  }
   ...
   */
  async ledgerGetWriteLedgersGetRaw(): Promise<
    runtime.ApiResponse<ConfigurableWriteLedgers>
  > {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ConfigurableWriteLedgersFromJSON(jsonValue),
    );
  }
   ...
   * Fetch list of available write ledgers
   */
  async ledgerGetWriteLedgersGet(): Promise<ConfigurableWriteLedgers> {
    const response = await this.ledgerGetWriteLedgersGetRaw();
    return await response.value();
  }
   ...
   * Set write ledger
   */
  async ledgerLedgerIdSetWriteLedgerPutRaw(
    requestParameters: LedgerLedgerIdSetWriteLedgerPutRequest,
  ): Promise<runtime.ApiResponse<WriteLedger>> {
    if (
      requestParameters.ledgerId === null ||
      requestParameters.ledgerId === undefined
    ) {
      throw new runtime.RequiredError(
        'ledgerId',
        'Required parameter requestParameters.ledgerId was null or undefined when calling ledgerLedgerIdSetWriteLedgerPut.',
      );
    }
    ...
    const response = await this.request({
      path: `/ledger/{ledger_id}/set-write-ledger`.replace(
        `{${'ledger_id'}}`,
        encodeURIComponent(String(requestParameters.ledgerId)),
      ),
      method: 'PUT',
      headers: headerParameters,
      query: queryParameters,
   ...
   * Set write ledger
   */
  async ledgerLedgerIdSetWriteLedgerPut(
    requestParameters: LedgerLedgerIdSetWriteLedgerPutRequest,
  ): Promise<WriteLedger> {
    const response =
      await this.ledgerLedgerIdSetWriteLedgerPutRaw(requestParameters);
    return await response.value();
  }
