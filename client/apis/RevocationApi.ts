...
export interface RevocationActiveRegistryCredDefIdRotatePostRequest {
  credDefId: string;
}
...
export class RevocationApi extends runtime.BaseAPI {
  ...
  async revocationActiveRegistryCredDefIdGet(
    ...
    const response =
      await this.revocationActiveRegistryCredDefIdGetRaw(requestParameters);
   ...
   */
  async revocationActiveRegistryCredDefIdRotatePostRaw(
    requestParameters: RevocationActiveRegistryCredDefIdRotatePostRequest,
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'credDefId',
        'Required parameter requestParameters.credDefId was null or undefined when calling revocationActiveRegistryCredDefIdRotatePost.',
      );
    }
    ...
    const response = await this.request({
      path: `/revocation/active-registry/{cred_def_id}/rotate`.replace(
        `{${'cred_def_id'}}`,
        encodeURIComponent(String(requestParameters.credDefId)),
      ),
      method: 'POST',
   ...
   * Rotate revocation registry
   */
  async revocationActiveRegistryCredDefIdRotatePost(
    requestParameters: RevocationActiveRegistryCredDefIdRotatePostRequest,
  ): Promise<RevRegsCreated> {
    const response =
      await this.revocationActiveRegistryCredDefIdRotatePostRaw(
        requestParameters,
      );
    return await response.value();
  }
  ...
  async revocationClearPendingRevocationsPost(
    ...
    const response =
      await this.revocationClearPendingRevocationsPostRaw(requestParameters);
    return await response.value();
  }
  ...
  async revocationCreateRegistryPost(
    ...
    const response =
      await this.revocationCreateRegistryPostRaw(requestParameters);
    return await response.value();
  }
  ...
  async revocationCredentialRecordGet(
    ...
    const response =
      await this.revocationCredentialRecordGetRaw(requestParameters);
    return await response.value();
  }
  ...
  async revocationPublishRevocationsPost(
    ...
    const response =
      await this.revocationPublishRevocationsPostRaw(requestParameters);
    return await response.value();
  }
  ...
  async revocationRegistriesCreatedGet(
    ...
    const response =
      await this.revocationRegistriesCreatedGetRaw(requestParameters);
    return await response.value();
  }
  ...
  async revocationRegistryDeleteTailsFileDelete(
    ...
    const response =
      await this.revocationRegistryDeleteTailsFileDeleteRaw(requestParameters);
    return await response.value();
  }
  ...
  async revocationRegistryRevRegIdDefinitionPost(
    ...
    const response =
      await this.revocationRegistryRevRegIdDefinitionPostRaw(requestParameters);
    return await response.value();
  }
  ...
  async revocationRegistryRevRegIdEntryPost(
    ...
    const response =
      await this.revocationRegistryRevRegIdEntryPostRaw(requestParameters);
    return await response.value();
  }
  ...
  async revocationRegistryRevRegIdGet(
    ...
    const response =
      await this.revocationRegistryRevRegIdGetRaw(requestParameters);
    return await response.value();
  }
  ...
  async revocationRegistryRevRegIdIssuedDetailsGet(
    ...
    const response =
      await this.revocationRegistryRevRegIdIssuedDetailsGetRaw(
        requestParameters,
      );
    return await response.value();
  }
  ...
  async revocationRegistryRevRegIdIssuedGet(
    ...
    const response =
      await this.revocationRegistryRevRegIdIssuedGetRaw(requestParameters);
    return await response.value();
  }
  ...
  async revocationRegistryRevRegIdIssuedIndyRecsGet(
    ...
    const response =
      await this.revocationRegistryRevRegIdIssuedIndyRecsGetRaw(
        requestParameters,
      );
    return await response.value();
  }
  ...
  async revocationRegistryRevRegIdPatch(
    ...
    const response =
      await this.revocationRegistryRevRegIdPatchRaw(requestParameters);
    return await response.value();
  }
  ...
  async revocationRegistryRevRegIdSetStatePatch(
    ...
    const response =
      await this.revocationRegistryRevRegIdSetStatePatchRaw(requestParameters);
    return await response.value();
  }
  ...
  async revocationRegistryRevRegIdTailsFileGet(
    ...
    const response =
      await this.revocationRegistryRevRegIdTailsFileGetRaw(requestParameters);
    return await response.value();
  }
  ...
  async revocationRegistryRevRegIdTailsFilePut(
    ...
    const response =
      await this.revocationRegistryRevRegIdTailsFilePutRaw(requestParameters);
    return await response.value();
  }
