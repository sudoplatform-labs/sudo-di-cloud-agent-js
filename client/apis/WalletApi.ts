...
import {
  ...
  DIDResultToJSON,
  FetchKeyResponse,
  FetchKeyResponseFromJSON,
  FetchKeyResponseToJSON,
  JWSCreate,
  JWSCreateFromJSON,
  JWSCreateToJSON,
  JWSVerify,
...
export interface WalletKeysMultikeyGetRequest {
  multikey: string;
}

export interface WalletKeysPostRequest {
  body?: CreateKeyRequest;
}

export interface WalletKeysPutRequest {
...
export class WalletApi extends runtime.BaseAPI {
  ...
  async walletDidLocalRotateKeypairPatch(
    ...
    const response =
      await this.walletDidLocalRotateKeypairPatchRaw(requestParameters);
    return await response.value();
  }
   ...
   * Fetch key info.
   */
  async walletKeysMultikeyGetRaw(
    requestParameters: WalletKeysMultikeyGetRequest,
  ): Promise<runtime.ApiResponse<FetchKeyResponse>> {
    if (
      requestParameters.multikey === null ||
      requestParameters.multikey === undefined
    ) {
      throw new runtime.RequiredError(
        'multikey',
        'Required parameter requestParameters.multikey was null or undefined when calling walletKeysMultikeyGet.',
      );
    }
    ...
    const response = await this.request({
      path: `/wallet/keys/{multikey}`.replace(
        `{${'multikey'}}`,
        encodeURIComponent(String(requestParameters.multikey)),
      ),
      method: 'GET',
      headers: headerParameters,
      query: queryParameters,
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      FetchKeyResponseFromJSON(jsonValue),
    );
  }
   ...
   * Fetch key info.
   */
  async walletKeysMultikeyGet(
    requestParameters: WalletKeysMultikeyGetRequest,
  ): Promise<FetchKeyResponse> {
    const response = await this.walletKeysMultikeyGetRaw(requestParameters);
    return await response.value();
  }
   ...
   * Create a key pair
   */
  async walletKeysPostRaw(
    requestParameters: WalletKeysPostRequest,
  ): Promise<runtime.ApiResponse<CreateKeyResponse>> {
    const queryParameters: any = {};
    ...
    const response = await this.request({
      ...
      headers: headerParameters,
      query: queryParameters,
      body: CreateKeyRequestToJSON(requestParameters.body),
    });

    return new runtime.JSONApiResponse(response, (jsonValue) =>
      CreateKeyResponseFromJSON(jsonValue),
    );
  }
   ...
   * Create a key pair
   */
  async walletKeysPost(
    requestParameters: WalletKeysPostRequest,
  ): Promise<CreateKeyResponse> {
    const response = await this.walletKeysPostRaw(requestParameters);
    return await response.value();
  }
   ...
   */
  async walletKeysPutRaw(
    requestParameters: WalletKeysPutRequest,
  ): Promise<runtime.ApiResponse<UpdateKeyResponse>> {
    const queryParameters: any = {};
    ...
    const response = await this.request({
      ...
      headers: headerParameters,
      query: queryParameters,
      body: UpdateKeyRequestToJSON(requestParameters.body),
    });

    return new runtime.JSONApiResponse(response, (jsonValue) =>
      UpdateKeyResponseFromJSON(jsonValue),
    );
  }
  ...
  async walletKeysPut(
    ...
    const response = await this.walletKeysPutRaw(requestParameters);
    return await response.value();
  }
