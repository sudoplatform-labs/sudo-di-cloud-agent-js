...
export class IssueCredentialV10Api extends runtime.BaseAPI {
  ...
  async issueCredentialRecordsCredExIdProblemReportPost(
    ...
    const response = await this.issueCredentialRecordsCredExIdProblemReportPostRaw(
      requestParameters,
    );
    return await response.value();
  }
  ...
  async issueCredentialRecordsCredExIdSendRequestPost(
    ...
    const response = await this.issueCredentialRecordsCredExIdSendRequestPostRaw(
      requestParameters,
    );
    return await response.value();
  }
