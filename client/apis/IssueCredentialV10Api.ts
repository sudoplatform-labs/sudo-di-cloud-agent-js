...
export interface IssueCredentialRecordsGetRequest {
  ...
  limit?: number;
  offset?: number;
  orderBy?: IssueCredentialRecordsGetOrderByEnum;
...
export class IssueCredentialV10Api extends runtime.BaseAPI {
  ...
  async issueCredentialCreateOfferPost(
    ...
    const response =
      await this.issueCredentialCreateOfferPostRaw(requestParameters);
  ...
  async issueCredentialRecordsCredExIdDelete(
    ...
    const response =
      await this.issueCredentialRecordsCredExIdDeleteRaw(requestParameters);
    return await response.value();
  }
  ...
  async issueCredentialRecordsCredExIdGet(
    ...
    const response =
      await this.issueCredentialRecordsCredExIdGetRaw(requestParameters);
    return await response.value();
  }
  ...
  async issueCredentialRecordsCredExIdIssuePost(
    ...
    const response =
      await this.issueCredentialRecordsCredExIdIssuePostRaw(requestParameters);
    return await response.value();
  }
  ...
  async issueCredentialRecordsCredExIdSendOfferPost(
    ...
    const response =
      await this.issueCredentialRecordsCredExIdSendOfferPostRaw(
        requestParameters,
      );
    return await response.value();
  }
  ...
  async issueCredentialRecordsCredExIdStorePost(
    ...
    const response =
      await this.issueCredentialRecordsCredExIdStorePostRaw(requestParameters);
    return await response.value();
  }
  ...
  async issueCredentialSendOfferPost(
    ...
    const response =
      await this.issueCredentialSendOfferPostRaw(requestParameters);
    return await response.value();
  }
  ...
  async issueCredentialSendProposalPost(
    ...
    const response =
      await this.issueCredentialSendProposalPostRaw(requestParameters);
    return await response.value();
  }
}
 ...
 * @enum {string}
 */
export enum IssueCredentialRecordsGetOrderByEnum {
  Id = 'id',
}
/**
 * @export
