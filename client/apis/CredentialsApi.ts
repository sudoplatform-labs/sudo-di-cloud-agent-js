...
export class CredentialsApi extends runtime.BaseAPI {
  ...
  async credentialCredentialIdDelete(
    ...
    const response =
      await this.credentialCredentialIdDeleteRaw(requestParameters);
  ...
  async credentialMimeTypesCredentialIdGet(
    ...
    const response =
      await this.credentialMimeTypesCredentialIdGetRaw(requestParameters);
    return await response.value();
  }
  ...
  async credentialRevokedCredentialIdGet(
    ...
    const response =
      await this.credentialRevokedCredentialIdGetRaw(requestParameters);
    return await response.value();
  }
  ...
  async credentialW3cCredentialIdDelete(
    ...
    const response =
      await this.credentialW3cCredentialIdDeleteRaw(requestParameters);
    return await response.value();
  }
  ...
  async credentialW3cCredentialIdGet(
    ...
    const response =
      await this.credentialW3cCredentialIdGetRaw(requestParameters);
    return await response.value();
  }
