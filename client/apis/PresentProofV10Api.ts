...
export class PresentProofV10Api extends runtime.BaseAPI {
  ...
  async presentProofRecordsPresExIdSendPresentationPost(
    ...
    const response = await this.presentProofRecordsPresExIdSendPresentationPostRaw(
      requestParameters,
    );
    return await response.value();
  }
  ...
  async presentProofRecordsPresExIdVerifyPresentationPost(
    ...
    const response = await this.presentProofRecordsPresExIdVerifyPresentationPostRaw(
      requestParameters,
    );
    return await response.value();
  }
