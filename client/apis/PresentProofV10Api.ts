...
export interface PresentProofRecordsGetRequest {
  ...
  limit?: number;
  offset?: number;
  orderBy?: PresentProofRecordsGetOrderByEnum;
...
export class PresentProofV10Api extends runtime.BaseAPI {
  ...
  async presentProofCreateRequestPost(
    ...
    const response =
      await this.presentProofCreateRequestPostRaw(requestParameters);
  ...
  async presentProofRecordsPresExIdCredentialsGet(
    ...
    const response =
      await this.presentProofRecordsPresExIdCredentialsGetRaw(
        requestParameters,
      );
    return await response.value();
  }
  ...
  async presentProofRecordsPresExIdDelete(
    ...
    const response =
      await this.presentProofRecordsPresExIdDeleteRaw(requestParameters);
    return await response.value();
  }
  ...
  async presentProofRecordsPresExIdGet(
    ...
    const response =
      await this.presentProofRecordsPresExIdGetRaw(requestParameters);
    return await response.value();
  }
  ...
  async presentProofRecordsPresExIdProblemReportPost(
    ...
    const response =
      await this.presentProofRecordsPresExIdProblemReportPostRaw(
        requestParameters,
      );
    return await response.value();
  }
  ...
  async presentProofRecordsPresExIdSendRequestPost(
    ...
    const response =
      await this.presentProofRecordsPresExIdSendRequestPostRaw(
        requestParameters,
      );
    return await response.value();
  }
  ...
  async presentProofSendProposalPost(
    ...
    const response =
      await this.presentProofSendProposalPostRaw(requestParameters);
    return await response.value();
  }
  ...
  async presentProofSendRequestPost(
    ...
    const response =
      await this.presentProofSendRequestPostRaw(requestParameters);
    return await response.value();
  }
}
 ...
 * @enum {string}
 */
export enum PresentProofRecordsGetOrderByEnum {
  Id = 'id',
}
/**
 * @export
